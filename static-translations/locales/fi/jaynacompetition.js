export default {
  ...
  jaynacompetitionHeading:
    'Turun paikalliset jäynäkilpailut ovat käynnissä 4.3.–23.4.!',
  ...
  jaynaText3:
    'Hyväksytystä osallistumisesta palkitaan myös Paavo Nurmi -aiheisella haalarimerkillä.',
  jaynaText4:
  ...
  jaynaText7:
    'Kaikkien joukkueiden tulee toimittaa jäynädokumentaationsa Teekkarikomission hallitukselle (teekkarikomissio ja sit semmonen a:n näkönen merkki lists.utu.fi) 23.4.2021 klo. 23.59 mennessä esimerkiksi kuva-, video- ja/tai kirjallisena materiaalina.',
  jaynaText8:
    'Haluamme sinut edustamaan Turkua jäynäfinaaliin, joten perusta joukkue ja ala miettiä hyvää jäynää!',
  jaynaText9:
    'Lisää infoa Teekkarikomission kulttuurikomissaarilta, Niklas Luomalalta (Telegram: @henrywestons).',
  jaynaText10:
  ...
  jaynaRuleText6:
    'Joukkueen koko on kolmesta kymmeneen (3–10) jäynääjää, joista vähintään puolet ovat teekkareita tai teekkarifukseja. Joukkueen tulee nimetä itselleen kapteeni, joka vastaa joukkueen viestinnästä tuomariston suuntaan. Joukkueen kapteenin tulee olla teekkari.',
  jaynaRuleText7:
    'Fuksijoukkue koostuu kolmesta kymmeneen (3–10) jäynääjästä, joista enintään yksi on teekkari ja loput teekkarifukseja. Fuksijoukkueessa joukkueen kapteeni voi olla myös teekkarifuksi.',
  jaynaRuleText8:
