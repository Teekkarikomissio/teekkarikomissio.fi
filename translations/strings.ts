...
const strings: Strings = {
    ...
    techStudentBody:
      'Teekkarikomissiolla on neljä jäsentä - Turussa toimivat teekkariyhdistykset. Jokainen Digit ry:n, Nucleus ry:n, Datateknologerna vid Åbo Akademi rf:n tai Kemistklubben vid Åbo Akademi rf:n äänioikeutettu jäsen on siis automaagisesti oikeutettu osallistumaan TK:n toimintaan!',
    // For companies
    forCompaniesHeading: 'Yrityksille',
    forCompaniesBody: `Teekkarikomission jäseniä ovat kaikkien jäsenyhdistysten jäsenet. Kauttamme yrityksesi voi tavoittaa
    opiskelijoita ja työssäkäyviä teekkareita sekä muodostaa positiivisen vaikutelman verkostomme jäsenille.
    Teemme mielellämme yhteistyötä esimerkiksi tapahtumanäkyvyyden muodossa mm. seuraavissa tapahtumissa:`,
  },
  sv: {
    // Nav
    ...
    capBodyTwo: 'Käännös kesken',
    capBodyThree: 'Käännös kesken',
    capBodyFour: 'Käännös kesken',
    capHeadingTwo: 'Käännös kesken',
    capBodyFive: 'Käännös kesken',
    // Being Tech Student
    techStudentHeading: 'Medlemsföreningar',
    techStudentBody:
      'Teknologkommissionen har fyra medlemmar, nämligen de teknologföreningar som har sin verksamhet i Åbo. Varje röstberättigad medlem av Digit ry, Nucleus ry, Datateknologerna vid Åbo Akademi rf och Kemistklubben vid Åbo Akademi rf är alltså automatiskt berättigad att delta i TK:s verksamhet!',
    // For companies
